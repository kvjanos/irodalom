{
	...
	"inRepository": true,
	"browserSupport": "gcs",
	"lastUpdated": "2012-03-08 07:45:00"
}
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//h1[@class="title-news"]|//h1[@class="title-news entry-title"]'),
title            : FW.Xpath('//h1[@class="title-news"]|//h1[@class="title-news entry-title"]').text().trim(),
...
date             : FW.Xpath('//meta[@name="publish_date"]/@content').text().replace(/^.+,/, ""),
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/search\.huffingtonpost/),
choices          : {
  titles :  FW.Xpath('//a[@class="find"]').text().trim(),
  urls    :  FW.Xpath('//a[@class="find"]').key("href")
}
});
		...
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://www.huffingtonpost.com/dan-solin/their-confidence-is-killi_b_1112953.html?view=print&comm_ref=false",
						"title": "Huffington Post",
						"type": "text/html"
					}
				],
		...
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://www.huffingtonpost.com/2011/11/28/prepaid-cards_n_1117226.html?view=print&comm_ref=false",
						"title": "Huffington Post",
						"type": "text/html"
					}
				],
