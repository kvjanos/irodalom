...
detect           : FW.Xpath('//a[@class="ir newsweek-flag"]'),
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Xpath('//div[@class="pagination"]/a[@href="http://andrewsullivan.thedailybeast.com/"]'),
title            : FW.Xpath('//div[@class="entry"]/h1/a').text().trim(),
attachments      : [{ url: FW.Url(),
  title:  "The Dish Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//ul[@class="mastheadList"]/li[2]/h2/em').text().cleanAuthor("author"),
date             : FW.Xpath('//time').text().replace(/\|/,"").trim(),
publicationTitle : "Andrew Sullivan - The Dish"
});

/**Multiple - Daily Dish and Search */
FW.MultiScraper({
itemType         : 'multiple',
...
var testCases = [
	{
		"type": "web",
		"url": "http://andrewsullivan.thedailybeast.com/2011/06/hathos-alert-4.html",
		"items": [
			{
				"itemType": "blogPost",
				"creators": [
				...
				"url": "http://andrewsullivan.thedailybeast.com/2011/06/hathos-alert-4.html",
				"date": "15 Jun 2011 08:02 AM",
				"publicationTitle": "Andrew Sullivan - The Dish",
				"title": "Tea Party Summer Camp",
		...
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://www.thedailybeast.com/articles/2011/09/26/mikheil-saakashvili-interview-hillary-clinton-saved-georgia.print.html",
						"title": "Daily Beast Snapshot",
						"type": "text/html"
					}
				],
