...
attachments      : [{ url: FW.Url().remove(/\?page=full/).append("?page=full"),
  ...
  type: "text/html" }],
creators         : FW.Xpath('//h3/span[@id="by-line"]').text().remove(/BY /).capitalizeTitle(true).split(/,/).cleanAuthor("author"),
date             : FW.Xpath('//h3/span[@id="pub-date"]').text().capitalizeTitle(true),
tags             : FW.Xpath('//div[@id="sub-tags"]/span[@class="fp_red"]/a').text().capitalizeTitle(true),
...
tags             : FW.Xpath('//div[@class="subjects"]/a').text().capitalizeTitle(true),
