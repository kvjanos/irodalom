{
	...
	"inRepository": true,
	"browserSupport": "gcs",
	"lastUpdated": "2012-03-17 08:15:00"
}
...
creators : FW.Xpath('//meta[@name="citation_author"]/@content').text().cleanAuthor("author", "true"),
...
var testCases = [
	{
		"type": "web",
		"url": "http://spiedigitallibrary.org/jei/resource/1/jeime5/v9/i1/p72_s1?bypassSSO=1",
		"items": [
			{
				"itemType": "journalArticle",
				"creators": [
					...
					{
						"firstName": "Rui Luís V. P. M.",
						"lastName": "Pires",
						"creatorType": "author"
					},
					{
						"firstName": "Danny",
						"lastName": "De Vleeschauwer",
						"creatorType": "author"
					},
					{
						"firstName": "Ignace",
	...
	{
		"type": "web",
		"url": "http://jcp.aip.org/resource/1/jcpsa6/v135/i22/p224903_s1?isAuthorized=no",
		"items": [
			{
				"itemType": "journalArticle",
				"creators": [
				...
				"ISSN": "00219606",
				"issue": "22",
				"pages": "224903-224903-10",
				"publicationTitle": "The Journal of Chemical Physics",
				"title": "Self-localized domain walls at π-conjugated branching junctions",
				"volume": "135",
				"libraryCatalog": "SPIE/AIP",
				"accessDate": "CURRENT_TIMESTAMP"
			}
