{
	...
	"inRepository": true,
	"browserSupport": "g",
	"lastUpdated": "2012-02-24 06:15:00"
}
...
/** BEGIN TEST CASES **/
/** automatic translator testing doesn't work - translator actually does work.
var testCases = [
	{
		"type": "web",
		"url": "http://abimperio.net/cgi-bin/aishow.pl?state=showa&idart=85&idlang=1&Code=",
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://abimperio.net/cgi-bin/aishow.pl?state=pdf;fn=201009/sarkisova%20historiography%20rus%202002-3.pdf;Code=",
						"title": "Ab Imperio PDF",
						"type": "application/pdf"
					},
					{
				...
				"issue": "3",
				"publicationTitle": "Ab Imperio",
				"title": "Degrees of Unfreedom: In Search of a Lost Subjectivity (Review Essay: Jeffrey Brooks, Thank You, Comrade Stalin! Soviet Public Culture From Revolution to Cold War)",
				"libraryCatalog": "Ab Imperio",
				"accessDate": "CURRENT_TIMESTAMP",
				"shortTitle": "Degrees of Unfreedom"
			}
		]
	},
	{
		"type": "web",
		"url": "http://abimperio.net/cgi-bin/aishow.pl?state=srch&idlang=1&s=russia",
		"items": "multiple"
	}
]
*/
