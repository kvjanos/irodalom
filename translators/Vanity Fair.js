...
publicationTitle : FW.Xpath('//li[@class="current"]/a').text().trimInternal().prepend("Vanity Fair Blogs - "),
language : "en-US",
ISSN: "0733-8899",
tags: FW.Xpath('//dd[@class="tag10"]').text().trimInternal()
});
...
/** Search results */
/* "disabled bc of permission denied error." <== is this still happening?*/
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//section[@class="feature search-result "]'),
choices : {
	titles : FW.Xpath('//div[@id="content"]//section[@class="feature search-result "]/h2/a[not(contains(@href,"/toc/")) and not(contains(@href,"/archive/"))]')
					.text().trim(),
	urls : FW.Xpath('//div[@id="content"]//section[@class="feature search-result "]/h2/a[not(contains(@href,"/toc/")) and not(contains(@href,"/archive/"))]')
					.key('href').text() }
});  
		...
		"items": [
			{
				...
				"ISSN": "0733-8899",
				"language": "en-US",
				"publicationTitle": "Vanity Fair Blogs - VF Daily",
		...
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://www.vanityfair.com/society/features/2011/05/top-one-percent-201105.print.html",
						"title": "Vanity Fair Snapshot",
						"type": "text/html"
					}
				],
