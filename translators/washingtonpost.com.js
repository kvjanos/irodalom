...
detect           : FW.Url().match(/\/search\.html(\?.+?&|\?)st=/) &&
					FW.Xpath('//div[@class="resultBlock"]/div[@class="resultDisplay"]/h2/a[normalize-space(text()) or normalize-space(node()/text())]'),
choices          : {
  titles :  FW.Xpath('//div[@class="resultBlock"]/div[@class="resultDisplay"]/h2/a[normalize-space(text()) or normalize-space(node()/text())]').text().trim(),
  urls    :  FW.Xpath('//div[@class="resultBlock"]/div[@class="resultDisplay"]/h2/a[normalize-space(text()) or normalize-space(node()/text())]').key("href")
}
});
