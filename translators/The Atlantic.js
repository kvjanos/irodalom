{
	...
	"inRepository": true,
	"browserSupport": "gcs",
	"lastUpdated": "2012-03-06 05:20:00"
}
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//p[@class="bio"]/span[@class="authors"]/a'),
title            : FW.Xpath('//h1[@class="headline"]').text().trim(),
attachments      : [{ url: FW.Url().replace(/archive/,"print"),
  title:  "The Atlantic Print View",
  type: "text/html" }],
creators         : FW.Xpath('//p/span[@class="authors"]/a').text().cleanAuthor("author"),
date             : FW.Xpath('//span[@class="date"]').text().trim(),
...
detect           : FW.Xpath('//div[@class="magazineContent"]'),
title            : FW.Xpath('//h1[@class="headline"]').text().trim(),
attachments      : [{ url: FW.Url().replace(/archive/,"print"),
  title:  "The Atlantic Print View",
  type: "text/html" }],
creators         : FW.Xpath('//h5/span/a[@class="author"]').text().cleanAuthor("author"),
date             : FW.Xpath('//div[@class="metadata"]/a[@class="issueTitle"]').text().remove(/ATLANTIC MAGAZINE/),
abstractNote     : FW.Xpath('//div[@class="post"]/p[@class="blurb"]').text(),
publicationTitle : "The Atlantic",
ISSN             : "1072-7825"
}); 
...
choices          : {
  titles :  FW.Xpath('//div[@class="post"]/h3/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="post"]/h3/a').key("href").text()
}
}); 
...
choices          : {
  titles :  FW.Xpath('//div[@id="searchResults"]/div[@class="post"]/h3/a').text().trim(),
  urls    :  FW.Xpath('//div[@id="searchResults"]/div[@class="post"]/h3/a').key("href").text()
}
});
...
var testCases = [
	...
	{
		"type": "web",
		"url": "http://www.theatlantic.com/magazine/archive/2011/07/the-world-8217-s-schoolmaster/8532/",
		"items": [
			{
				"itemType": "magazineArticle",
				"creators": [
				...
				"attachments": [
					{
						"url": "http://www.theatlantic.com/magazine/print/2011/07/the-world-8217-s-schoolmaster/8532/",
						"title": "The Atlantic Print View",
						"type": "text/html"
					}
				],
