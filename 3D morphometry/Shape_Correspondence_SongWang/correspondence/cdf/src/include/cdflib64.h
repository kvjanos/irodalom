...
STATICforIDL CDFstatus WriteVarElems64 PROTOARGs((
  struct VarStruct *Var, vFILE *fp, OFF_T offset, Int32 numElems, void *buffer
));
...
/*
STATICforIDL CDFstatus CompressZLIB0_64 PROTOARGs((
  vFILE *srcFp, OFF_T srcOffset, OFF_T srcSize, CDFstatus srcError,
  vFILE *destFp, OFF_T destOffset, OFF_T *destSize, CDFstatus destError
));
STATICforIDL CDFstatus DecompressZLIB0_64 PROTOARGs((
  vFILE *srcFp, OFF_T srcOffset, OFF_T iSize, CDFstatus srcError, 
  vFILE *destFp, OFF_T destOffset, CDFstatus destError
));
*/
