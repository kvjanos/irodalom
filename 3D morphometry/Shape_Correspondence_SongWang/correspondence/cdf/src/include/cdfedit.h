...
#define EDITrVarsIN             2
#define EDITgAttrsIN            4
#define EDITvAttrsIN            6
#define CHANGEcompressionIN     1
#define CHANGEencodingIN        3
#define CHANGEmajorityIN        5
#define CHANGEformatIN          7

#define BROWSEinOFFSET          8
