...
#define DEFAULTpageDUMP         FALSE           /* [no]page */
#define DEFAULTsizesDUMP        FALSE           /* [no]sizes */
#define DEFAULTindexingDUMP     FALSE           /* [no]indexing */
#define DEFAULTsummaryDUMP      TRUE            /* [no]summary */
#define DEFAULTradixDUMP	10		/* 10 = decimal (file offsets),
						   16 = hexadecimal. */
#define DEFAULTlevelDUMP        1               /* 1 == "brief",
						   2 == "most",
						   3 == "full" */
