...
switch (Va->item) {
  ...
  ****************************************************************************/
  case CDF_INFO_: {
    ...
    if (magicNumber1 != V3magicNUMBER_1) { /* Not V3.0. */
      V_close64 (dotFp, NULL); /* Close it and then open it with V2.0. */
  ...
  ****************************************************************************/
  ...
  case zVAR_MAXallocREC_: {
    ...
    struct CDFstruct *CDF;
    Int32 maxRec, lastAllocatedRecN; OFF_T offset;
  ...
  ****************************************************************************/
  ...
  case zVARs_RECDATA_: {
    ...
    Int32 recNum, varNt; Byte *tBuffer; int varX;
