...
(C) Copyright 1990-2006 NASA/GSFC\012\
Space Physics Data Facility\012\
NASA/Goddard Space Flight Center\012\
Greenbelt, Maryland 20771 USA\012\
(Internet -- CDFSUPPORT@LISTSERV.GSFC.NASA.GOV)\012", CDF_COPYRIGHT_LEN);
  return;
}
...
break;
/*
case ZLIB_COMPRESSION_ERROR:
strcpyX (textPtr,
"ZLIB_COMPRESSION_ERROR: Error during Zlib compression/decompressing.",
CDF_STATUSTEXT_LEN);
break;
*/
...
default:
sprintf (textPtr, "Text not found - unknown CDF status code (%ld).", status);
