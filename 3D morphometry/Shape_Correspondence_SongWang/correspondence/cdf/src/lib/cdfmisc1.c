  ...
  if (!CDF->singleFile) {
    ...
    **************************************************************************/
    if (CDF->rVars != NULL) {
	 ...
	 if (Var != NULL) {
	   if (Var->fp != NULL) {
	     if (!CLOSEv(Var->fp,NULL)) sX (VAR_CLOSE_ERROR, &pStatus);
	     Var->fp = NULL;
	   }
	 }
      }
...
Logical deleteCDF;      /* Delete CDF file(s)? */
{
  ...
  ****************************************************************************/
  if (deleteCDF) {
    ...
    **************************************************************************/
    if (CDF->dotFp != NULL) V_close (CDF->dotFp, NULL);
    if (CDF->uDotFp != NULL) V_close (CDF->uDotFp, NULL);
    CloseVarFiles (CDF);
  }
  /****************************************************************************
