...
if (cacheOut1 != 5) QuitCDF ("2.1", status);
if (cacheOut2 != 5) QuitCDF ("2.2", status);
if (cacheOut3 != 6) QuitCDF ("2.3", status);
...
if (formatOut != SINGLE_FILE) QuitCDF ("16.1", status);
