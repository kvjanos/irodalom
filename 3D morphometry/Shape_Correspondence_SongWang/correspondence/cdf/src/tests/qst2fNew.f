...
C-----------------------------------------------------------------------
	...
	DATA ENCODING/NETWORK_ENCODING/, MAJORITY/COL_MAJOR/,
...
C-----------------------------------------------------------------------
        ...
        IF (STATUS .LT. CDF_OK) CALL QUIT_CDF (STATUS, '6.1')
...
C-----------------------------------------------------------------------
	...
	IF (ENCODING_OUT .NE. ENCODING) CALL QUIT_CDF (STATUS, '7.10')
...
C-----------------------------------------------------------------------
	...
	IF (ENCODING_OUT .NE. ENCODING) CALL QUIT_CDF (STATUS, '22.4')
	IF (MAJORITY_OUT .NE. MAJORITY) CALL QUIT_CDF (STATUS, '22.5')
	IF (MAX_ZREC_OUT .NE. 10) CALL QUIT_CDF (STATUS, '22.6')
...
C-----------------------------------------------------------------------
	...
	IF (READONLYmode .NE. READONLYon) CALL QUIT_CDF (STATUS, '29.8')
