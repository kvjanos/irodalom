...
o = osl.obj version.obj $S\funcadd0.obj
...
version.c: version.c0
	sed -f $S/ssw version.c0 >version.c

# Student version...

sv = osl.obj sversion.obj $S\sjac0dim.obj $S\funcadd0.obj

sosl.exe: $(sv)
	wcl386 -l=nt -bt=nt -fe=sosl.exe $(sv) $L

sversion.c: version.c
	sed -f sosl.ss version.c >sversion.c
